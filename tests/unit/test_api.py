...
class TestWorkflowAPI:
    ...
    @patch('src.services.temporal_service.get_temporal_client')
    def test_get_workflow_status_success(self, mock_get_client, fastapi_client: TestClient):
    ...
    @patch('src.services.temporal_service.get_temporal_client')
    def test_get_workflow_status_not_found(self, mock_get_client, fastapi_client: TestClient):
    ...
    @patch('src.services.temporal_service.get_temporal_client')
    def test_get_workflow_result_success(self, mock_get_client, fastapi_client: TestClient):
